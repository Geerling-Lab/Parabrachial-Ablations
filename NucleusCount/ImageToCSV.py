...
if __name__ == "__main__":
    ...
    parser.add_argument("-l", "--labels", type=str, help="Input labels file path")
    ...
    assert os.path.exists(os.path.join(args.folder, args.labels)), "Image does not exist: %s" % os.path.join(args.folder, args.labels)
