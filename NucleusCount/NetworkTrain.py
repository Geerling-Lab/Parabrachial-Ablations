...
def baseline_model():
    num_classes = 2
    model = Sequential()
    model.add(Conv2D(filters=32, kernel_size=(5, 5), input_shape=(SIZE, SIZE, 3), activation="relu", data_format="channels_last"))
...
if __name__ == "__main__":
    ...
    model.fit(train_X, train_Y, validation_data=(test_X, test_Y), epochs=10, batch_size=50)
